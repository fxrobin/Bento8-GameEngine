...
Hero_MoveUpdatePos
	...
	ADDD TEST1X10_X_SPS         * Ajout du reste subpixel
	STB TEST1X10_X_SPS+1		* sauvegarde du nouveau reste subpixel
...
Hero_MoveUpdatePos_03
	STB TEST1X10_X_POS	
	LDB #$00					
	STB TEST1X10_X_SPS			* reste subpixel est sur un octet stocké sur deux
