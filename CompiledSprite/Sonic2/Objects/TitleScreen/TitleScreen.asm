...
Obj_SmallStar           equ TitleScr_Object_RAM+(object_size*3)
Obj_SonicHand           equ TitleScr_Object_RAM+(object_size*4)
Obj_TailsHand           equ TitleScr_Object_RAM+(object_size*5)
Obj_EmblemFront01       equ TitleScr_Object_RAM+(object_size*6)
Obj_EmblemFront02       equ TitleScr_Object_RAM+(object_size*7)
Obj_EmblemFront03       equ TitleScr_Object_RAM+(object_size*8)
Obj_EmblemFront04       equ TitleScr_Object_RAM+(object_size*9)
Obj_EmblemFront05       equ TitleScr_Object_RAM+(object_size*10)
Obj_EmblemFront06       equ TitleScr_Object_RAM+(object_size*11)
Obj_EmblemFront07       equ TitleScr_Object_RAM+(object_size*12)
Obj_EmblemFront08       equ TitleScr_Object_RAM+(object_size*13)
Obj_EmblemBack01        equ TitleScr_Object_RAM+(object_size*14)
Obj_EmblemBack02        equ TitleScr_Object_RAM+(object_size*15)
Obj_EmblemBack03        equ TitleScr_Object_RAM+(object_size*16)
Obj_EmblemBack04        equ TitleScr_Object_RAM+(object_size*17)
Obj_EmblemBack05        equ TitleScr_Object_RAM+(object_size*18)
Obj_EmblemBack06        equ TitleScr_Object_RAM+(object_size*19)
Obj_EmblemBack07        equ TitleScr_Object_RAM+(object_size*20)
Obj_EmblemBack08        equ TitleScr_Object_RAM+(object_size*21)
Obj_EmblemBack09        equ TitleScr_Object_RAM+(object_size*22)
Obj_PaletteHandler      equ TitleScr_Object_RAM+(object_size*23)
Obj_PaletteHandler2     equ TitleScr_Object_RAM+(object_size*24)
Obj_PaletteHandler3     equ TitleScr_Object_RAM+(object_size*25)
TitleScr_Object_RAM_End equ TitleScr_Object_RAM+(object_size*26)
