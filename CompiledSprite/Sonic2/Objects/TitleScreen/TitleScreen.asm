...
TitleScreenMenu            equ Object_RAM+(object_size*12)
IntroSmallStar2            equ Object_RAM+(object_size*13)
...
TitleScreen_Routines                   *Obj0E_Index:    offsetTable
        fdb   TitleScreen_Init         *                offsetTableEntry.w Obj0E_Init   ;   0
        fdb   TitleScreen_Sonic        *                offsetTableEntry.w Obj0E_Sonic  ;   2
        fdb   TitleScreen_Tails        *                offsetTableEntry.w Obj0E_Tails  ;   4
        ...
        fdb   TitleScreen_TailsHand    *                offsetTableEntry.w Obj0E_TailsHand      ; $10
                                       *; ===========================================================================
                                       *; loc_12E38:
TitleScreen_Init                       *Obj0E_Init:
       ...
       bra   TitleScreen               *        bra.s   Obj0E
                                       *; ===========================================================================
                                       *
TitleScreen_Sonic                      *Obj0E_Sonic:
        ldd   frame_count,u
        addd  #1                       *        addq.w  #1,objoff_34(a0)
        std   frame_count,u
        cmpd  #$120                    *        cmpi.w  #$120,objoff_34(a0)
        bhs   TitleScreen_Sonic_01     *        bhs.s   +
        bsr   TitleScreen_SetFinalState
	                               *        bsr.w   TitleScreen_SetFinalState
TitleScreen_Sonic_01                   *+
                                       *        moveq   #0,d0
        lda   routine_secondary,u      *        move.b  routine_secondary(a0),d0
        ldx   TitleScreen_Sonic_Routines
                                       *        move.w  off_12E76(pc,d0.w),d1
        jmp   [a,x]                    *        jmp     off_12E76(pc,d1.w)
                                       *; ===========================================================================
TitleScreen_Sonic_Routines             *off_12E76:      offsetTable
        fdb   TitleScreen_Sonic_Init   *                offsetTableEntry.w Obj0E_Sonic_Init     ;   0
        fdb   TitleScreen_loc_12EC2    *                offsetTableEntry.w loc_12EC2    ;   2
        fdb   TitleScreen_loc_12EE8    *                offsetTableEntry.w loc_12EE8    ;   4
        fdb   TitleScreen_loc_12F18    *                offsetTableEntry.w loc_12F18    ;   6
        fdb   TitleScreen_loc_12F52    *                offsetTableEntry.w loc_12F52    ;   8
        fdb   TitleScreen_Sonic_LastFrame
                                       *                offsetTableEntry.w Obj0E_Sonic_LastFrame        ;  $A
        fdb   TitleScreen_loc_12F7C    *                offsetTableEntry.w loc_12F7C    ;  $C
        fdb   TitleScreen_loc_12F9A    *                offsetTableEntry.w loc_12F9A    ;  $E
        fdb   TitleScreen_loc_12FD6    *                offsetTableEntry.w loc_12FD6    ; $10
        fdb   TitleScreen_loc_13014    *                offsetTableEntry.w loc_13014    ; $12
                                       *; ===========================================================================
                                       *; spawn more stars
TitleScreen_Sonic_Init                 *Obj0E_Sonic_Init:
...
TitleScreen_SonicHand                  *Obj0E_SonicHand:
                                       ...
                                       *; ===========================================================================
                                       *
TitleScreen_TailsHand                  *Obj0E_TailsHand:
                                       *        moveq   #0,d0
                                       *        move.b  routine_secondary(a0),d0
