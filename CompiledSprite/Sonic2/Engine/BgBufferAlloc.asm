...
BBA0        
        ldx   #Lst_FreeCellFirstEntry_0     ; save previous cell.next_cell into x for future update
        ldy   Lst_FreeCellFirstEntry_0      ; load first cell for screen buffer 0
        bra   BBA_Next
        
BBA1        
        ldx   #Lst_FreeCellFirstEntry_1     ; save previous cell.next_cell into x for future update
        ldy   Lst_FreeCellFirstEntry_1      ; load first cell for screen buffer 1
        
BBA_Next                                    ; loop thru all free cells        
        ...
        leax  next_cell,y                   ; save previous cell.next_cell into x for future update        
        ldy   next_cell,y                   ; move to next cell
        bra   BBA_Next
