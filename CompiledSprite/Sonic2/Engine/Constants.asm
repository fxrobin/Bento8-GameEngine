...
render_mirror_mask            equ $03 ; (bit 0 & bit 1) mask for x_mirror and y_mirror
...
rsv_render_onscreen_0_mask    equ $00 ; (bit 0) has been rendered on screen buffer 0
rsv_render_onscreen_1_mask    equ $00 ; (bit 1) has been rendered on screen buffer 1
rsv_render_erasesprite_mask   equ $00 ; (bit 2) if a sprite need to be cleared on screen
