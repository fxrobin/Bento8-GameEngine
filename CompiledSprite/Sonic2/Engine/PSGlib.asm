...
* register map (6809=z80)
* A=A, B=B, X=HL, Y=DE or IY, U=BC or IX
* Here:
* A=A, B=B, X=HL, Y=BC
...
_sendVolume2PSG:
attention ci dessous remplacer a par b
...
_output_NoLatch:
  ...
  jp _send2PSG                 ; otherwise, it is for chn 0 or 1 so we have done!
