...
* Alternance de la RAMA et RAM B dans l'espace écran
* ------------------------------------------------------------------------------
*
* Page Affichée par l'automate Vidéo
* ----------------------------------
*   $E7DD determine la page affichee à l'écran
...
*
* Demi-Page 0 en espace écran (4000 à 5FFF)
* -----------------------------------------
*   $E7C3 détermine la demi-page de la page 0 visible dans l'espace écran
*   bit0=0 : 8Ko RAMA
*   bit0=1 : 8ko RAMB
*
********************************************************************************
...
WaitVBL_01
        ...
        bmi   WaitVBL_01         * tant que le bit est à 1 on boucle
SwapVideoPage
        ...
        stb   $E7DD              * changement page (2 ou 3) affichée à l'écran
...
am_SwapVideoPage
        ...
        ldb   $E7C3              * charge l'identifiant de la Demi-Page 0 configurée en espace écran
        andb  #$01
        bne   SwapVideoPage_01   * si bit0==1, branch
        inc   $E7C3              * bit0=1 changement demi-page RAMB de la page 0 visible dans l'espace écran
        rts
SwapVideoPage_01
