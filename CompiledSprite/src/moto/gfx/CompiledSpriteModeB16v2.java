...
public class CompiledSpriteModeB16v2 {
	...
	public List<String> getCodeStart() {
		...
		code.add("*---------------------------------------------------------------------------");
		code.add("Hero_Move");
		code.add("\tLDA JOY_DIR_STATUS");
		code.add("\tCMPA #JOY_G");
		code.add("\tBNE Hero_NotLeft");
		code.add("\tBRA Hero_MoveLeft");
		code.add("");
		code.add("Hero_NotLeft                   * XREF: Hero_Move");
		code.add("\tCMPA #JOY_D");
		code.add("\tBNE Hero_NotLeftOrRight");
		code.add("\tLBRA Hero_MoveRight");
		code.add("");
		code.add("Hero_NotLeftOrRight            * XREF: Hero_NotLeft");
		code.add("\tLDD TEST1X10_G_SPEED");
		code.add("\tCMPD #$0000");
		code.add("\tBLT Hero_NotLeftOrRight_00 * se deplace a gauche");
		code.add("\tSUBD TEST1X10_FRICTION     * se deplace a droite on soustrait la friction a la vitesse");
		code.add("\tBCC Hero_NotLeftOrRight_01 * si on passe en dessous de 0 on repositionne a 0");
		code.add("\tLDD #$0000");
		code.add("\tSTD TEST1X10_G_SPEED");
		code.add("\tLDA #$01                  * Charge animation IDLE R");
		code.add("\tSTA TEST1X10_ANIMATION");
		code.add("\tLBRA Hero_MoveUpdatePos");
		code.add("Hero_NotLeftOrRight_01	       ");
		code.add("\tCMPD #TEST1X10_JOG_SPD_LIMIT");
		code.add("\tBGE Hero_NotLeftOrRight_02");
		code.add("\tSTD TEST1X10_G_SPEED");
		code.add("\tLDA #$03                  * Charge animation WALK R");
		code.add("\tSTA TEST1X10_ANIMATION");
		code.add("\tBRA Hero_NotLeftOrRight_03");
		code.add("Hero_NotLeftOrRight_02	");
		code.add("\tSTD TEST1X10_G_SPEED");
		code.add("Hero_NotLeftOrRight_03");
		code.add("\tLBRA Hero_MoveUpdatePos");
		code.add("Hero_NotLeftOrRight_00	");
		code.add("\tADDD TEST1X10_FRICTION     * se deplace a gauche on ajoute la friction a la vitesse negative");
		code.add("\tBCC Hero_NotLeftOrRight_11 * si on passe au dessus de 0 on repositionne a 0");
		code.add("\tLDD #$0000");
		code.add("\tSTD TEST1X10_G_SPEED");
		code.add("\tLDA #$02                  * Charge animation IDLE L");
		code.add("\tSTA TEST1X10_ANIMATION");
		code.add("\tLBRA Hero_MoveUpdatePos");
		code.add("Hero_NotLeftOrRight_11	       ");
		code.add("\tCMPD #TEST1X10_JOG_SPD_LIMIT");
		code.add("\tBLE Hero_NotLeftOrRight_12");
		code.add("\tSTD TEST1X10_G_SPEED");
		code.add("\tLDA #$04                  * Charge animation WALK L");
		code.add("\tSTA TEST1X10_ANIMATION");
		code.add("\tBRA Hero_NotLeftOrRight_13");
		code.add("Hero_NotLeftOrRight_12	");
		code.add("\tSTD TEST1X10_G_SPEED");
		code.add("Hero_NotLeftOrRight_13");
		code.add("\tLBRA Hero_MoveUpdatePos");
		code.add("");
		code.add("Hero_MoveLeft                  	* XREF: Hero_Move");
		code.add("\tLDD TEST1X10_G_SPEED       	* Chargement de la vitesse au sol");
		code.add("\tCMPD #$0000                	* Test orientation");
		code.add("\tBLE Hero_MoveLeft_00       	* BRANCH si orientation a GAUCHE");
		code.add("\tSUBD TEST1X10_DECELERATION 	* orientation a DROITE on reduit la vitesse");
		code.add("\tBCC Hero_MoveLeft_03       	* BRANCH si orientation toujours a DROITE");
		code.add("\tLDD #$0000				   	");
		code.add("\tSUBD TEST1X10_DECELERATION 	* si la vitesse est devenue negative on la force a la valeur de -DECELERATION");
		code.add("Hero_MoveLeft_03	           	");
		code.add("\tSTD TEST1X10_G_SPEED       	* On stocke la vitesse");
		code.add("\tLBRA Hero_MoveUpdatePos	   	* Mise a jour des coordonnees");
		code.add("Hero_MoveLeft_00		       	* Orientation a GAUCHE ");
		code.add("*\tCMPD #$0000					* Comparaison avec la vitesse nulle");
		code.add("*\tBNE Hero_MoveLeft_02     	* BRANCH vitesse au sol non nulle");
		code.add("*\tLDD #$FEFF					* init vitesse de depart");
		code.add("*Hero_MoveLeft_02");
		code.add("\tCMPD TEST1X10_NEG_TOP_SPEED	* Comparaison avec la vitesse maximum");
		code.add("\tBEQ Hero_MoveUpdatePos     	* vitesse au sol deja au maximum - Mise a jour des coordonnees");
		code.add("\tSUBD TEST1X10_ACCELERATION 	* acceleration");
		code.add("\tCMPD TEST1X10_NEG_TOP_SPEED	* Comparaison avec la vitesse maximum");
		code.add("\tBGT Hero_MoveLeft_01       	* BRANCH si vitesse inferieur au maximum");
		code.add("\tLDA #$06                   	* Charge animation RUN L");
		code.add("\tSTA TEST1X10_ANIMATION     	* Sauvegarde animation");
		code.add("\tLDD TEST1X10_NEG_TOP_SPEED 	* Limitation de la vitesse au maximum");
		code.add("\tSTD TEST1X10_G_SPEED       	* Enregistrement de la vitesse");
		code.add("\tLBRA Hero_MoveUpdatePos    	* Mise a jour des coordonnees");
		...
		code.add("\tLDD TEST1X10_G_SPEED        * Chargement de la vitesse au sol");
		code.add("\tCMPD #$0000                 * Test orientation");
		code.add("\tBGE Hero_MoveRight_00       * BRANCH si orientation a DROITE");
		code.add("\tADDD TEST1X10_DECELERATION 	* orientation a GAUCHE on reduit la vitesse");
		code.add("\tBCC Hero_MoveRight_03       * BRANCH si orientation toujours a GAUCHE");
		code.add("\tLDD TEST1X10_DECELERATION   * si la vitesse est devenue positive on la force a la valeur de DECELERATION");
		code.add("Hero_MoveRight_03	");
		code.add("\tSTD TEST1X10_G_SPEED        * On stocke la vitesse");
		code.add("\tLBRA Hero_MoveUpdatePos		* Mise a jour des coordonnees");
		code.add("Hero_MoveRight_00		      	* Orientation a DROITE ");
		code.add("*\tCMPD #$0000					* Comparaison avec la vitesse nulle");
		code.add("*\tBNE Hero_MoveRight_02     	* BRANCH vitesse au sol non nulle");
		code.add("*\tLDD #$0100					* init vitesse de depart");
		code.add("*Hero_MoveRight_02");
		code.add("\tCMPD TEST1X10_TOP_SPEED		* Comparaison avec la vitesse maximum");
		code.add("\tBEQ Hero_MoveUpdatePos      * vitesse au sol deja au maximum - Mise a jour des coordonnees");
		code.add("\tADDD TEST1X10_ACCELERATION 	* acceleration");
		code.add("\tCMPD TEST1X10_TOP_SPEED		* Comparaison avec la vitesse maximum");
		code.add("\tBLT Hero_MoveRight_01       * BRANCH si vitesse inferieur au maximum");
		code.add("\tLDA #$05                    * Charge animation RUN R");
		code.add("\tSTA TEST1X10_ANIMATION		* Sauvegarde animation");
		code.add("\tLDD TEST1X10_TOP_SPEED		* Limitation de la vitesse au maximum");
		code.add("\tSTD TEST1X10_G_SPEED		* Enregistrement de la vitesse");
		code.add("\tLBRA Hero_MoveUpdatePos		* Mise a jour des coordonnees");
		...
		code.add("\tSTA TEST1X10_ANIMATION		* Sauvegarde animation");
		code.add("");
		code.add("Hero_MoveUpdatePos");
		code.add("\tLDD TEST1X10_G_SPEED		* Chargement de la vitesse au sol");
		code.add("\tSTD TEST1X10_X_SPEED        * Stockage vitesse X TODO xsp = gsp*cos(angle)");
		code.add("\tCMPD #$0000                 * Test orientation");
		code.add("\tBLT Hero_MoveUpdatePos_00   * BRANCH si orientation a GAUCHE");
		code.add("\tTFR A,B                     * Division par 256");
		code.add("\tADDB TEST1X10_X_POS			* Ajout de la vitesse a la position");
		code.add("\tBRA Hero_MoveUpdatePos_01");
		code.add("Hero_MoveUpdatePos_V00");
		code.add("\tFCB $00");
		code.add("Hero_MoveUpdatePos_00");
		code.add("\tLDD #$0000");
		code.add("\tSUBD TEST1X10_X_SPEED		* La vitesse negative est convertie en positive");
		code.add("\tTFR A,B                     * Division par 256");
		code.add("\tSTB Hero_MoveUpdatePos_V00");
		code.add("\tLDB TEST1X10_X_POS");
		code.add("\tSUBB Hero_MoveUpdatePos_V00 * Ajout de la vitesse a la position");
		code.add("Hero_MoveUpdatePos_01");
		code.add("*\tCMPB #$50					* Test de butee ecran a droite");
		code.add("*\tBLE Hero_MoveUpdatePos_02	* Butee non atteinte");
		code.add("*\tLDB #$50					* Butee atteinte on limite a la butee");
		code.add("*Hero_MoveUpdatePos_02");
		code.add("*    CMPB #$0C					* Test de la butee ecran a gauche");
		code.add("*\tBGE Hero_MoveUpdatePos_03	* Butee non atteinte");
		code.add("*\tLDB #$0C					* Butee atteinte on limite a la butee");
		code.add("Hero_MoveUpdatePos_03");
		code.add("\tSTB TEST1X10_X_POS			");
		code.add("\tLDD #$0000                  * TODO ysp = gsp*-sin(angle)");
		code.add("\tSTD TEST1X10_Y_SPEED");
		code.add("\tTFR A,B                     * division par 256");
		code.add("\tADDB TEST1X10_Y_POS");
		code.add("\tSTB TEST1X10_Y_POS");
		code.add("\tRTS");
		code.add("");
		...
		code.add("\tLDA TEST1X10_X_POS");
		code.add("\tLSRA");
		code.add("\tBCS Compute_Position_01");
		code.add("\tSTA Compute_Position_02+1");
		code.add("\tLDA #$28");
		code.add("\tLDB TEST1X10_Y_POS");
		code.add("\tDECB");
		code.add("\tMUL");
		code.add("\tADDD Compute_Position_02");
		code.add("\tSTD POS_TEST1X100000");
		code.add("\tADDD #$2000");
		code.add("\tSTD POS_TEST1X100000+2");
		code.add("\tRTS");
		code.add("Compute_Position_01");
		code.add("\tSTA Compute_Position_02+1");
		code.add("\tLDA #$28");
		code.add("\tLDB TEST1X10_Y_POS");
		code.add("\tDECB");
		...
		code.add("********************************************************************************");
		code.add("TEST1X10_WALK_SPD_LIMIT EQU $0400");
		code.add("TEST1X10_JOG_SPD_LIMIT  EQU $0600");
		code.add("TEST1X10_X_POS");
		code.add("\tFCB $50        * position horizontale");
		code.add("TEST1X10_Y_POS");
		code.add("\tFCB $C8        * position verticale");
