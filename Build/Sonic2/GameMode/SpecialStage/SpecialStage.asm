...
@a                                                    *+
       ...
       std   SpecialStage_CurrentSegment              *    move.w  #0,(SpecialStage_CurrentSegment).w
        ...
        ; Pal fade in                                 *    bsr.w   Pal_FadeFromWhite
                                                      ...
                                                      *    bsr.w   LoadPLC
        rts                                           *
SpecialStageMain                                      *-   bsr.w   PauseGame
                                                      *    cmpi.b  #GameModeID_SpecialStage,(Game_Mode).w ; special stage mode?
                                                      *    bne.w   SpecialStage_Unpause        ; if not, branch
                                                      *    move.b  #VintID_S2SS,(Vint_routine).w
                                                      *    bsr.w   WaitForVint
        ; manual launch of an object
        ; from a dynamic memory page
        ; (not the resident page 1)
        ...
        jsr   RunPgSubRoutine
        ldu   #HalfPipeEven
        jsr   RunPgSubRoutine                         *    bsr.w   SSTrack_Draw
...
SpecialObjectLocations
        INCLUDEBIN "./GameMode/SpecialStage/Special stage object location lists.bin"
